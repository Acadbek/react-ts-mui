      ...
      <div className="relative mt-8 p-6 overflow-x-auto shadow-[10px_10px_50px_0px_#64748B0A] sm:rounded-lg bg-white">
            ...
            <tr className='bg-[#edf2f7] h-16 box-border leading-6 tracking-[0.2px] text-left'>
              <th scope="col" className="p-4">
                <div className="flex items-center">
                  <input id="checkbox-all-search" type="checkbox" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 focus:ring-offset-gray-100 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" />
          ...
          <tbody className='text-base text-[#0F172A] font-semibold leading-6 tracking-[0.20px] text-left'>
            {data?.map(item => (
              <tr key={item?.id} className="bg-white h-16 border-b border-[#F1F5F9]">
                ...
                <th scope="row" className="flex items-center pl-2 gap-4 px-6 py-4 font-medium text-gray-900 whitespace-nowrap">
                  <img className='w-12 h-12' src={item.productImages[0] || 'https://picsum.photos/seed/picsum/200/300'} alt="" />
                  {item?.title}
                </th>
        ...
        <nav className="flex items-center flex-column flex-wrap md:flex-row justify-between pt-4" aria-label="Table navigation">
          ...
          <ul className="inline-flex -space-x-px rtl:space-x-reverse text-sm h-8">
            <li>
              <a href="#" className="flex items-center justify-center px-3 h-8 ms-0 leading-tight text-gray-500 bg-white border border-gray-300 rounded-l-lg hover:bg-gray-100 hover:text-gray-700">Previous</a>
            </li>
            <li>
